    ...
    <DayPicker
      ...
      components={{
        ...
        Chevron: ({ className: chevronClassName, orientation, ...chevronProps }) => {
          ...
          return (
            <ChevronDown className={cn('size-4', chevronClassName)} aria-hidden {...chevronProps} />
          );
        },
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        'flex aspect-square size-auto w-full min-w-8 flex-col gap-1 font-normal leading-none',
