...
export function FigmaSection_n_2270_14191() {
  return (
    <section data-figma-node="2270:14191" className="absolute box-border left-[337px] top-[2235px] mt-[306px] w-[1267px] h-[519px] flex flex-row items-center gap-12">
      ...
      <img data-figma-node="3795:12052" src="/assets/figma/3795-12052.png" alt="Content Library" className="box-border w-[700px] h-[519px] overflow-hidden rounded-[10px] max-w-none object-cover object-top" />
    </section>
  );
}
