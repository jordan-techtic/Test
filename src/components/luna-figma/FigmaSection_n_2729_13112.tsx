        ...
        <div data-figma-node="2729:13119" className="box-border w-[640px] h-[389px] absolute left-[50px] top-[283px] gap-5">
          <div data-figma-node="2729:13120" className="box-border w-[640px] h-[52px] absolute left-[0px] top-[0px] gap-4">
            <div data-figma-node="2729:13121" className="box-border w-[312px] h-[52px] absolute left-[0px] top-[0px] overflow-hidden rounded-full pr-[20px] pl-[20px]" style={{backgroundColor: "rgba(255, 255, 255, 0.05)"}}>
              <input data-figma-node="2729:13127" type="text" placeholder="First Name" aria-label="First Name" className="box-border w-[272px] h-[16px] absolute left-[20px] top-[18px] border-0 bg-transparent shadow-none ring-0 px-0 focus-visible:ring-0 focus-visible:outline-none text-[#ffffff] placeholder:text-[#ffffff] font-almarai text-[14px] font-[400] leading-[16px] text-left whitespace-nowrap" />
            </div>
            <div data-figma-node="2729:13137" className="box-border w-[312px] h-[52px] absolute left-[328px] top-[0px] overflow-hidden rounded-full pr-[20px] pl-[20px]" style={{backgroundColor: "rgba(255, 255, 255, 0.05)"}}>
              <input data-figma-node="2729:13143" type="text" placeholder="Last Name" aria-label="Last Name" className="box-border w-[272px] h-[16px] absolute left-[20px] top-[18px] border-0 bg-transparent shadow-none ring-0 px-0 focus-visible:ring-0 focus-visible:outline-none text-[#ffffff] placeholder:text-[#ffffff] font-almarai text-[14px] font-[400] leading-[16px] text-left whitespace-nowrap" />
          ...
          <div data-figma-node="2729:13153" className="box-border w-[640px] h-[52px] absolute left-[0px] top-[72px] gap-4">
            <div data-figma-node="2729:13154" className="box-border w-[312px] h-[52px] absolute left-[0px] top-[0px] overflow-hidden rounded-full pr-[20px] pl-[20px]" style={{backgroundColor: "rgba(255, 255, 255, 0.05)"}}>
              <input data-figma-node="2729:13160" type="email" placeholder="Email" aria-label="Email" className="box-border w-[272px] h-[16px] absolute left-[20px] top-[18px] border-0 bg-transparent shadow-none ring-0 px-0 focus-visible:ring-0 focus-visible:outline-none text-[#ffffff] placeholder:text-[#ffffff] font-almarai text-[14px] font-[400] leading-[16px] text-left whitespace-nowrap" />
            ...
            <div data-figma-node="2729:13170" className="box-border w-[312px] h-[52px] absolute left-[328px] top-[0px] overflow-hidden rounded-full pr-[20px] pl-[20px]" style={{backgroundColor: "rgba(255, 255, 255, 0.05)"}}>
              <input data-figma-node="2729:13176" type="tel" placeholder="Phone number" aria-label="Phone number" className="box-border w-[272px] h-[16px] absolute left-[20px] top-[18px] border-0 bg-transparent shadow-none ring-0 px-0 focus-visible:ring-0 focus-visible:outline-none text-[#ffffff] placeholder:text-[#ffffff] font-almarai text-[14px] font-[400] leading-[16px] text-left whitespace-nowrap" />
          ...
          <div data-figma-node="2729:13187" className="box-border w-[640px] h-[54px] absolute left-[0px] top-[144px] overflow-hidden rounded-full pr-[20px] pl-[20px]" style={{backgroundColor: "rgba(255, 255, 255, 0.05)"}}>
            <input data-figma-node="2729:13193" type="text" placeholder="How long have you been in Real Estate?" aria-label="How long have you been in Real Estate?" className="box-border w-[600px] h-[16px] absolute left-[20px] top-[19px] border-0 bg-transparent shadow-none ring-0 px-0 focus-visible:ring-0 focus-visible:outline-none text-[#ffffff] placeholder:text-[#ffffff] font-almarai text-[14px] font-[400] leading-[16px] text-left whitespace-nowrap" />
          ...
          <div data-figma-node="2729:13204" className="box-border w-[640px] h-[54px] absolute left-[0px] top-[218px] overflow-hidden rounded-full pr-[20px] pl-[20px]" style={{backgroundColor: "rgba(255, 255, 255, 0.05)"}}>
            <input data-figma-node="2729:13210" type="text" placeholder="What do you currently do for marketing your business?" aria-label="What do you currently do for marketing your business?" className="box-border w-[600px] h-[16px] absolute left-[20px] top-[19px] border-0 bg-transparent shadow-none ring-0 px-0 focus-visible:ring-0 focus-visible:outline-none text-[#ffffff] placeholder:text-[#ffffff] font-almarai text-[14px] font-[400] leading-[16px] text-left whitespace-nowrap" />
          ...
          <div data-figma-node="2729:13220" className="box-border w-[640px] h-[97px] absolute left-[0px] top-[292px] overflow-hidden rounded-[10px] pt-[20px] pr-[20px] pb-[20px] pl-[20px]" style={{backgroundColor: "rgba(255, 255, 255, 0.05)"}}>
            <textarea data-figma-node="2729:13226" placeholder="Your Message" aria-label="Your Message" className="box-border w-[600px] h-[16px] absolute left-[20px] top-[20px] border-0 bg-transparent shadow-none ring-0 px-0 focus-visible:ring-0 focus-visible:outline-none text-[#ffffff] placeholder:text-[#ffffff] font-almarai text-[14px] font-[400] leading-[16px] text-left whitespace-nowrap" />
            <div data-figma-node="2729:13227" className="box-border w-[40px] h-[40px] absolute left-[657px] top-[-263px]"></div>
          </div>
        </div>
        <a data-figma-node="2738:13270" href="#contact" className="box-border w-[202px] h-[50px] absolute left-[269px] top-[702px] rounded-full inline-flex items-center justify-center whitespace-nowrap hover:opacity-90" style={{backgroundColor: "rgba(200, 164, 126, 0.3)"}}><span className="font-almarai text-[18px] font-[400] leading-[20px] text-left whitespace-nowrap text-[#ffffff] whitespace-nowrap">Join the waitlist now</span></a>
      </div>
    </section>
  );
}
