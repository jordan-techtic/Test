...
export function FigmaSection_n_2729_13112() {
  return (
    <section data-figma-node="2729:13112" id="contact" className="absolute box-border left-[210px] top-[5737px] mt-[80px] w-[1500px] h-[802px] flex flex-row items-center gap-5">
      ...
      <div data-figma-node="2729:13115" className="box-border w-[740px] h-[802px] overflow-hidden rounded-[20px] relative gap-[30px] pt-[50px] pr-[50px] pb-[50px] pl-[50px]" style={{backgroundColor: "rgba(255, 255, 255, 0.04)"}}>
        ...
        <a data-figma-node="2738:13270" href="#contact" className="box-border w-[202px] h-[50px] absolute left-[269px] top-[702px] rounded-full inline-flex items-center justify-center whitespace-nowrap pt-[10px] pr-[24px] pb-[10px] pl-[24px] hover:opacity-90" style={{backgroundColor: "rgba(200, 164, 126, 0.3)"}}><span className="font-almarai text-[18px] font-[400] leading-[20px] text-left whitespace-nowrap text-[#ffffff] whitespace-nowrap">Join the waitlist now</span></a>
      </div>
    </section>
  );
}
