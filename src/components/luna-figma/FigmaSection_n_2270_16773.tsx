...
export function FigmaSection_n_2270_16773() {
  return (
    <section data-figma-node="2270:16773" className="absolute box-border left-[0px] top-[6619px] w-[1920px] h-[324px] block bg-[#000000]">
      ...
      <p data-figma-node="2270:16895" className="box-border w-[330px] h-[27px] absolute left-[1380px] top-[186px] font-almarai text-[24px] font-[400] leading-[27px] text-right whitespace-nowrap text-[#ffffff]">hello@agentwisemarketing.com</p>
      ...
      <div data-figma-node="2270:16914" className="box-border w-[245px] h-[18px] absolute left-[1465px] top-[290px] opacity-[0.6] gap-4">
        <p data-figma-node="2270:16915" className="box-border w-[116px] h-[18px] absolute left-[0px] top-[0px] font-almarai text-[16px] font-[400] leading-[18px] text-left whitespace-nowrap text-[#ffffff]">Terms of Service</p>
        <div data-figma-node="2270:16916" className="box-border w-[1px] h-[17px] absolute left-[132px] top-[0px] bg-[#e0e0e0]" />
        <p data-figma-node="2270:16917" className="box-border w-[97px] h-[18px] absolute left-[148px] top-[0px] font-almarai text-[16px] font-[400] leading-[18px] text-left whitespace-nowrap text-[#ffffff]">Privacy Policy</p>
      </div>
