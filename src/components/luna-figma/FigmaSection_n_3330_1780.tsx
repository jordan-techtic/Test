...
export function FigmaSection_n_3330_1780() {
  return (
    <section data-figma-node="3330:1780" id="about" className="absolute box-border left-[0px] top-[0px] w-[1920px] h-[1010px] block">
      ...
      <div data-figma-node="2252:10079" className="box-border w-[488px] h-[102px] absolute left-[716px] top-[840px] gap-5">
        <div data-figma-node="2252:10063" className="box-border w-[488px] h-[32px] absolute left-[0px] top-[0px] gap-1">
          <div data-figma-node="2252:10075" className="box-border w-[488px] h-[27px] absolute left-[0px] top-[2px] gap-1">
        ...
        <div data-figma-node="2252:10317" className="box-border w-[286px] h-[128px] absolute left-[1216px] top-[0px] gap-1">
          <div data-figma-node="2241:3485" className="box-border w-[286px] h-[128px] absolute left-[0px] top-[0px] overflow-hidden rounded-[7px] gap-2 pt-[15px] pr-[15px] pb-[15px] pl-[15px] border-[#44413e] border-[1px] bg-[#2f271f]">
            <div data-figma-node="2252:10306" className="box-border w-[256px] h-[30px] absolute left-[15px] top-[15px] gap-24">
              <div data-figma-node="2252:10110" className="box-border w-[236px] h-[30px] absolute left-[0px] top-[0px] gap-2.5">
                <div data-figma-node="2554:11669" className="box-border w-[30px] h-[30px] absolute left-[0px] top-[0px]">
                  <div data-figma-node="2554:11701" className="box-border w-[17px] h-[18px] absolute left-[7px] top-[6px]"></div>
                </div>
                <p data-figma-node="2252:10112" className="box-border w-[196px] h-[16px] absolute left-[40px] top-[7px] font-almarai text-[14px] font-[700] leading-[16px] text-left whitespace-nowrap text-[#ffffff]">This Week's Content Calendar</p>
              </div>
              <div data-figma-node="2252:10277" className="box-border w-[14px] h-[14px] absolute left-[334px] top-[-7px] rounded-[300px] border-[#c5a3a3] border-[1px]"></div>
            </div>
            <div data-figma-node="2241:3494" className="box-border w-[256px] h-[60px] absolute left-[15px] top-[53px] gap-1.5">
              <p data-figma-node="2241:3495" className="box-border w-[256px] h-[60px] absolute left-[0px] top-[0px] opacity-[0.6] font-almarai text-[14px] font-[400] leading-[20px] text-left text-[#ffffff]">See what's on deck to be published this week and how your social posts are performing.</p>
            </div>
          </div>
        </div>
        <div data-figma-node="2554:14104" className="box-border w-[259px] h-[136px] absolute left-[1325px] top-[446px] rounded-[7px] gap-1.5 pt-[15px] pr-[15px] pb-[15px] pl-[15px] border-[#44413e] border-[1px] bg-[#2f271f]">
          <div data-figma-node="2554:14105" className="box-border w-[198px] h-[27px] absolute left-[15px] top-[15px] gap-1.5">
            <div data-figma-node="2554:14106" className="box-border w-[27px] h-[27px] absolute left-[0px] top-[0px]"></div>
            <p data-figma-node="2554:14116" className="box-border w-[164px] h-[16px] absolute left-[34px] top-[5px] font-almarai text-[14px] font-[700] leading-[16px] text-left whitespace-nowrap text-[#ffffff]">Agentwise Ultimate Mind</p>
          </div>
          <div data-figma-node="2554:14117" className="box-border w-[229px] h-[72px] absolute left-[15px] top-[49px] gap-1.5">
            <p data-figma-node="2554:14118" className="box-border w-[229px] h-[72px] absolute left-[0px] top-[0px] opacity-[0.6] font-almarai text-[14px] font-[400] leading-[18px] text-left text-[#ffffff]">Agentwise Ultimate Mind is your strategic advisor and business partner customized for your business - not just a generic chatbot.</p>
          </div>
        </div>
