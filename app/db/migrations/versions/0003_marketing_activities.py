...
Revision ID: 0003_marketing_activities
...
revision: str = "0003_marketing_activities"
down_revision: Union[str, None] = "0002_marketing_team_members"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["created_by"], ["marketing_team_members.id"], ondelete="SET NULL"
        ),
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_marketing_activities_activity_date", table_name="marketing_activities"
    )
